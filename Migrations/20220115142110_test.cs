        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrginCountry = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Age = table.Column<string>(type: "nvarchar(255)", nullable: false),
                    Focus = table.Column<string>(type: "nvarchar(255)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Units_Mythologies_MythologyID",
                        column: x => x.MythologyID,
                        principalTable: "Mythologies",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
